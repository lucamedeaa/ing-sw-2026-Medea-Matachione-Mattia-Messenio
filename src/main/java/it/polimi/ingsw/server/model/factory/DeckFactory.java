...
import it.polimi.ingsw.server.model.card.building.scorer.ClassScorerArtist;
import it.polimi.ingsw.server.model.card.building.scorer.ClassScorerBuilder;
import it.polimi.ingsw.server.model.card.building.scorer.ClassScorerCollector;
import it.polimi.ingsw.server.model.card.building.scorer.ClassScorerHunter;
import it.polimi.ingsw.server.model.card.building.scorer.ClassScorerInventor;
import it.polimi.ingsw.server.model.card.building.scorer.ClassScorerShaman;
...
import it.polimi.ingsw.server.model.card.building.foodDiscount.FoodDiscountArtist;
import it.polimi.ingsw.server.model.card.building.foodDiscount.FoodDiscountCollector;
import it.polimi.ingsw.server.model.card.building.foodDiscount.FoodDiscountInventor;
