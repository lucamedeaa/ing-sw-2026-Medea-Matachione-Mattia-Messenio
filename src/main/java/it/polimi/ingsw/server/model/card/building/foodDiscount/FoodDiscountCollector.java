...
public class FoodDiscountCollector extends FoodDiscount {
    ...
    /** Constructs the FoodDiscountCollector building. @param idcard the card identifier @param foodCost food cost to acquire @param prestigePoints base prestige points @param era the card era @param characters character type (unused, fixed to COLLECTOR logic) */
