...
public final class Scenes {
    ...
    public static final SceneDefinition GAME_ENDED   = new SceneDefinition("/fxml/GameEndedScreen.fxml",     1280, 720, false);
    public static final SceneDefinition DISCONNECTED = new SceneDefinition("/fxml/DisconnectedScreen.fxml",  640,  360, true);
    public static final SceneDefinition VIEW_TRIBE   = new SceneDefinition("/fxml/ViewTribeScreen.fxml",     800,  600, false);
