...
public class ClientMain {
    public static void main(String[] args) {
        ...
        while (!connected) {
            ...
            try {
                server = NetworkClientFactory.createConnection(type, ip, port, receiver);
                connected = true; // Se arriva qui, la connessione è riuscita. Usciamo dal loop.
            } catch (Exception e) {
                System.out.println("\n \033[1;41;37m ERRORE DI CONNESSIONE \033[0m \033[1;31mImpossibile connettersi: " + e.getMessage() + "\033[0m\n");
            }
        }
